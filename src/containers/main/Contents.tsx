...
const Contents = ({ data }: Props) => {
  ...
  return (
    <div className="grid w-full grid-cols-3 gap-[1rem] px-[5rem] pb-[9rem] xl:grid-cols-4 xl:gap-[4.6rem] xl:px-[9rem]">
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                className="xl:w-[42.3rem]"
              >
                <AutoSizeImage
                  src={value.thumbnail}
                  className="h-[17rem] xl:h-[24rem]"
                  roundedTop={1.8}
                />
              </motion.div>
